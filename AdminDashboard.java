...
//	});
	...
	menuBar.add(m2);
        ...
        JMenuItem mi6 = new JMenuItem("VIEW BOOKINGS");
	m2.add(mi6);
...
//        
        ...
        mi6.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                try{
                    new ViewPackageBookings().setVisible(true);
                }catch(Exception e ){}
            }
	});
...
//        
	...
	menuBar.add(m3);
        ...
        JMenuItem mi8 = new JMenuItem("VIEW BOOKINGS");
	m3.add(mi8);
...
//	m3.add(mi10);
        ...
        mi8.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                try{
                    new ViewHotelBookings().setVisible(true);
                }catch(Exception e ){}
            }
	});
