...
public class ViewPackageBookings extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewPackageBookings frame = new ViewPackageBookings();
	...
	public ViewPackageBookings() throws SQLException {
		...
		contentPane.add(table);
                ...
                try{
                    Conn c = new Conn();
                        String displayPackagesql = "select * from bookpackage";
                        ResultSet rs = c.s.executeQuery(displayPackagesql);
		...
		lblCleanStatus.setBounds(130, 15, 76, 14);
		contentPane.add(lblCleanStatus);
		
		lblNewLabel = new JLabel("People");
		lblNewLabel.setBounds(260, 15, 46, 14);
		contentPane.add(lblNewLabel);
		
		lblNewLabel_1 = new JLabel("Id");
		lblNewLabel_1.setBounds(385, 15, 76, 14);
		contentPane.add(lblNewLabel_1);

		
		lblId = new JLabel("Number");
		lblId.setBounds(510, 15, 90, 14);
		contentPane.add(lblId);
                
                JLabel l3 = new JLabel("Phone");
		l3.setBounds(640, 15, 90, 14);
		contentPane.add(l3);
                
                JLabel l4 = new JLabel("Price");
		l4.setBounds(770, 15, 90, 14);
		contentPane.add(l4);
