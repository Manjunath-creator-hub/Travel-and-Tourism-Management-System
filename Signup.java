...
public class Signup extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
		...
		st.setString(5, textField_3.getText());
                ...
                String cust = "insert into customer values(?, NULL, NULL, ?, NULL, NULL, NULL, NULL, NULL)";
                PreparedStatement cust1 = con.c.prepareStatement(cust);
                
                cust1.setString(1, textField.getText());
                cust1.setString(2, textField_1.getText());
